...
1.  Perform *de novo* genome assembly using both short-read and
...
> Genome assembly is a key step in genomic analysis, enabling
> researchers to reconstruct the complete genomic sequence of an
> organism from raw sequencing data. This process is particularly
> significant for bacterial genomes, which are typically compact,
> circular, and rich in essential genetic information. Understanding
> bacterial genome assembly is essential for applications ranging from
> pathogen identification and antibiotic resistance profiling to
> studying microbial evolution and ecology. Genome assembly can broadly
> be categorised into two main approaches: *de novo* assembly, relies
> solely on overlaps or *k*-mers, and reference-based assembly, aligning
> reads to a known reference genome (**Figure 4.1**).

![](media/image1.png){width="4.9814468503937in" height="2.48625in"}

> **Figure 4.1 Two main methods for genome assembly from raw sequencing
> data.**
>
...
>
> ![](media/image2.png){width="5.12174978127734in"
> height="2.385832239720035in"}
>
> **Figure 4.2 Desired outcome of genome assembly of raw sequencing
> data**
>
> [De Bruijn graphs]{.underline}
>
...
>
> [Assembly graph vs final assembly]{.underline}
>
...
>
> YDATA, ESSI, LITY, ITYD, DQUAL, OODQ, HAPPI, ALIT, YDAT, QUALI, QUAL,
> SGOOD, TYDAT, INESS, DQUA, SSIS, PINES, APPI, PINE, NESS

## HAPP ![](media/image3.png){width="0.12861439195100613in" height="6.411636045494314e-2in"} APPI ![](media/image4.png){width="0.12861439195100613in" height="6.411636045494314e-2in"} PPIN ![](media/image3.png){width="0.12861439195100613in" height="6.411636045494314e-2in"} PINE

## INES ![](media/image5.png){width="0.12861439195100613in" height="6.411636045494314e-2in"} NESS

## 

> Raw sequencing reads split into *k*-mers:
>
> ALIT, APPI, DATA, DQUA, ESSI, GOOD, HAPP, INES, ITYD, LITY, NESS,
> OODQ, PINE, QUAL, SGOO, SSIS, TYDA, UALI, YDAT
>
> **Figure 4.3**
...
> tool, and no error. Navigate to the home directory:
>
> cd \~
>
...
> steps using the tools and commands shown in **Table 4.1** below.
...
> commands used are in **Table 4.1**:
>
> **Table 4.1 Commands used to pre-process the data**

+------------+----------------------------------------------------------+
| > Fastp    | > fastp \--in1 ERR4095909_1.fastq.gz \--in2              |
|            | > ERR4095909_2.fastq.gz \--out1 cpe004_R1.fastq.gz       |
|            | > \--out2 cpe004_R2.fastq.gz \--length_required 40       |
|            | > \--cut_front \--cut_tail \--cut_mean_quality 25        |
+============+==========================================================+
| > Porechop | > porechop -i cpe004_long.fastq.gz -o                    |
|            | > cpe004_porchop.fastq.gz                                |
+------------+----------------------------------------------------------+
| > Filtlong | > filtlong \--min_length 1000 \--keep_percent 95         |
|            | > cpe004_porechop.fastq.gz \| gzip \>                    |
|            | >                                                        |
|            | > cpe004_filtered.fastq.gz                               |
+------------+----------------------------------------------------------+
...
> Github:
> [[https://github.com/tseemann/shovill]{.underline}](https://github.com/tseemann/shovill)
>
> SPAdes assembler:
> [[https://doi.org/10.1002/cpbi.102]{.underline}](https://doi.org/10.1002/cpbi.102)
>
...
>
> ../course_data_2025/cp4/reads/cpe004_R1.fastq.gz \--R2
>
> ../course_data_2025/cp4/reads/cpe004_R2.fastq.gz && cp
> shovill/contigs.fa cpe004_shovill.fasta && cp shovill/contigs.gfa
> cpe004_shovill.gfa
>
...
![](media/image6.jpeg){width="4.317834645669292in" height="3.445in"}

> **Figure 4.5 Visualising the cpe004_shovill assembly graph file in
> Bandage.**
...
> DOI:
> [[https://doi.org/10.1038/s41587-019-0072-8]{.underline}](https://doi.org/10.1038/s41587-019-0072-8)
>
> Github:
> [[https://github.com/fenderglass/Flye]{.underline}](https://github.com/fenderglass/Flye)
>
...
>
> ../course_data_2025/cp4/reads/cpe004_filtered.fastq.gz && cp
> flye/assembly.fasta cpe004_flye.fasta && cp flye/assembly_graph.gfa
> cpe004_flye.gfa
>
...
> ![](media/image7.png){width="2.675673665791776in"
> height="1.03125in"}Unicycler: Resolving bacterial genome assemblies
> from short and long sequencing reads
>
> DOI:
> [[https://doi.org/10.1371/journal.pcbi.1005595]{.underline}](https://doi.org/10.1371/journal.pcbi.1005595)
> [[https://github.com/rrwick/Unicycler]{.underline}](https://github.com/rrwick/Unicycler)
>
...
>
> ../course_data_2025/cp4/reads/cpe004_R1.fastq.gz -2
>
> ../course_data_2025/cp4/reads/cpe004_R2.fastq.gz -l
>
> ../course_data_2025/cp4/reads/cpe004_filtered.fastq.gz && cp
...
> ![](media/image8.png){width="2.9749989063867015in"
> height="0.676344050743657in"}Autocyler: generating consensus long-read
> assemblies for bacterial genomes.
>
> [[https://github.com/rrwick/Autocycler/wiki]{.underline}](https://github.com/rrwick/Autocycler/wiki)
>
...
![](media/image9.png){width="4.1776049868766405in"
height="4.390833333333333in"}

> **Figure 4.6 Autocycler illustrated pipeline overview**

### Assembly quality check

> ![](media/image10.jpeg){width="2.2220581802274717in"
> height="0.7600437445319335in"}Genome assembly evaluation tool DOI:
> [10.1093/bioinformatics/bty266]{.underline} DOI:
> [10.1093/nar/gkad406]{.underline}
>
> Github:
> [[https://github.com/ablab/quast]{.underline}](https://github.com/ablab/quast)
>
...
+------------+-----------------------------------------------------------+
| Total      | > Combined length of all contigs in an assembly           |
| length     |                                                           |
+------------+-----------------------------------------------------------+
| N50        | > Length of the shortest contig such that 50% of the      |
|            | > assembly is covered by contigs of this length or longer |
+------------+-----------------------------------------------------------+
| N90        | > As above, but 90% of the assembly                       |
+------------+-----------------------------------------------------------+
| L50        | > Minimum number of contigs required to cover 50% of the  |
|            | > total assembly length                                   |
+------------+-----------------------------------------------------------+
| L90        | > As above, but 90% of the assembly                       |
+------------+-----------------------------------------------------------+

![](media/image11.png){width="5.930075459317585in"
height="0.8943744531933508in"}

> **Figure 4.7 Example genome of 100 bp length with the contigs
> assembled.**
>
> Run QUAST on all three assemblies generated in this practical:
>
> quast cpe004_shovill.fasta cpe004_flye.fasta cpe004_hybrid.fasta -o
> quast/
>
...
> *Prokka*: rapid prokaryotic genome annotation DOI:
> [10.1093/bioinformatics/btu153]{.underline}
>
> Github:
> [[https://github.com/tseemann/prokka]{.underline}](https://github.com/tseemann/prokka)
>
> ![A diagram of a pipeline AI-generated content may be
> incorrect.](media/image12.png){width="6.401388888888889in"
> height="3.6006944444444446in"}
>
> Figure 4.8 Simplified schematic of Prokka pipeline. Obtained from:
> <https://training.galaxyproject.org/training-material/topics/genome-annotation/tutorials/annotation-with-prokka/slides-plain.html>
>
...
+===============+====================================================+
| .gff          | > This is the master annotation in GFF3 format,    |
|               | > containing both sequences and annotations. It    |
|               | > can be viewed directly in Artemis or IGV.        |
+---------------+----------------------------------------------------+
| .gbk          | > This is a standard Genbank file derived from the |
|               | > master .gff. If the input to prokka was a        |
|               | > multi-FASTA, then this will be a multi-Genbank,  |
|               | > with one record for each sequence.               |
+---------------+----------------------------------------------------+
| .fna          | > Nucleotide FASTA file of the input contig        |
|               | > sequences.                                       |
+---------------+----------------------------------------------------+
| .faa          | > Protein FASTA file of the translated CDS         |
|               | > sequences.                                       |
+---------------+----------------------------------------------------+
| .ffn          | > Nucleotide FASTA file of all the prediction      |
...
|               | > correct taxonomy, authors, related publication   |
|               | > etc.                                             |
+---------------+----------------------------------------------------+
...
|               | > file, but with extra Sequin tags in the sequence |
|               | > description lines.                               |
+---------------+----------------------------------------------------+
| .tbl          | > Feature Table file, used by \"tbl2asn\" to       |
|               | > create the .sqn file.                            |
+---------------+----------------------------------------------------+
| .err          | > Unacceptable annotations - the NCBI discrepancy  |
|               | > report.                                          |
+---------------+----------------------------------------------------+
| .log          | > Contains all the output that Prokka produced     |
|               | > during its run.                                  |
+---------------+----------------------------------------------------+
| .txt          | > Statistics relating to the annotated features    |
|               | > found.                                           |
+---------------+----------------------------------------------------+
...
> Unicycler, **bc01_hybrid.fasta** and*
>
> ***bc01_hybrid.gfa**, as this step might take a long time. But first
